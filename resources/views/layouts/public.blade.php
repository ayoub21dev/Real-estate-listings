...
<head>
    ...
    <meta name="description" content="@yield('meta_description', 'Find your dream home with UrbanKey. We offer verified listings, expert agents, and a seamless buying experience.')">
    <meta property="og:title" content="@yield('og_title', 'UrbanKey - Find Your Dream Home')">
    ...
    <title>@yield('title', 'UrbanKey - Find Your Dream Home')</title>
    <link rel="icon" type="image/svg+xml" href="{{ asset('assets/brand/logo.svg') }}?v=2">
