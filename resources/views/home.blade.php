    ...
    <section class="relative bg-indigo-600 py-24 sm:py-32 isolate overflow-hidden">
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl text-center">
                <h2 class="text-3xl font-bold tracking-tight text-white sm:text-4xl">Ready to find your next home?</h2>
                ...
                <div class="mt-10 flex items-center justify-center gap-x-6">
                    <a href="{{ route('properties.index') }}" class="rounded-md bg-white px-5 py-3 text-sm font-semibold text-indigo-600 shadow-sm hover:bg-indigo-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white transition-all transform hover:scale-105">
                        Browse All Properties
                    </a>
                    <a href="{{ route('contact') }}" class="text-sm font-semibold leading-6 text-white hover:text-indigo-100 flex items-center gap-1 group">
